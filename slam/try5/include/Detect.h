...
//		Ptr<DescriptorExtractor> descriptor;
	...
	public:
		...
		void ransac_detect(vector<DMatch> tmp_matchpoint, vector<KeyPoint> tmp_lastkp, vector<KeyPoint> tmp_recentkp, DepthGenerator tmp_depth, DepthMetaData &tmp_depthmeta);
